...
% add the set_conn() to pass input of conn_matrix
% add the set_ctrl() to pass input of ctrl_flag
...
classdef Robotarium < ARobotarium
    ...
    methods
        ...
        function set_poses(this, poses) % added by Wenhao
            this.poses = poses;
        end
       
        function set_conn(this, conn_matrix)  % added by Wenhao
            this.conn_matrix = conn_matrix;    
        end
        
        function set_adj_matrix(this, adj_matrix)  % added by Wenhao
            this.adj_matrix = adj_matrix;    
        end
        
        function set_adj_flag(this, adj_flag)  % added by Wenhao
            this.adj_flag = adj_flag;    
        end
        
        
        function set_ctrl(this, ctrl_flag)  % added by Wenhao
            this.ctrl_flag = ctrl_flag;    
        end
        
        function set_type(this, type_flag) % addede by Chendi
