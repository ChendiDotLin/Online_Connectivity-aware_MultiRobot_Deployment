function [L_vals] = task_reallocation_movingtargets_multi_cap_go_to_point_mst_far(allocation_flag,res_num)
close all;
...
circle3 = viscircles(targets(:,3)',range,'Color','black');
...
% h13 = text(0.5,1.65,tt12,'FontSize',font);
...
% h23 = text(-1.4,-0.7,tt22,'FontSize',font);
...
%     save(strcat(strcat('res',num2str(res_num)),'.mat'),'timer_count','L_vals','dxi_vals');
    if (timer_count>=3500)
        break;
    end
end
