...
% this is an example for maintainning initial connectivity.
...
R2 = 0.25;
conn_matrix = GetConnMatrix_comparison(x, R2);
...
while(~init_checker(x, initial_conditions))
    ...
    conn_matrix = GetConnMatrix(x, R2); % simply test whether the connectivity constraint is violated
