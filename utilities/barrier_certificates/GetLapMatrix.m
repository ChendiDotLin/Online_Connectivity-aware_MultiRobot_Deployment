%% Get Laplacian Matrix from the Connected Graph
...
function lap_matrix = GetLapMatrix(xx, R2, varargin)

parser = inputParser;
addOptional(parser, 'warning_flag', 0);
parse(parser, varargin{:});

warning_flag = parser.Results.warning_flag;
